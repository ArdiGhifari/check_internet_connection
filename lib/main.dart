...
class _MyHomePageState extends State<MyHomePage> {
  ...
  //Sebuah objek untuk memeriksa koneksi internet
  final Connectivity _connectivity = Connectivity();

  // Langganan untuk mendengarkan perubahan koneksi
  StreamSubscription<ConnectivityResult>? _connectivitySubsctiption;
  ...
  void initState() {
    ...
    // Memanggil fungsi pengecekan koneksi internet dan mendengarkan perubahan koneksi
    // Setelah Selesai
    _initConnectionStatus().then((_) {
      _connectivitySubsctiption =
          _connectivity.onConnectivityChanged.listen((result) {
        setState(() {
          //Perbarui Status koneksi jika ada perubahan
